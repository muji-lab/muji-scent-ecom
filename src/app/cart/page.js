  ...
  return (
    <div className="bg-neutral-100 text-neutral-900 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-12 flex flex-col lg:flex-row gap-12">
                ...
                <div className="md:col-span-8 lg:col-span-9 p-6 flex flex-col gap-6">
                  ...
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      className="w-9 h-9 border border-neutral-300 rounded hover:bg-neutral-200"
                    >−</button>
        ...
        {/* Colonne résumé */}
        <aside className="lg:w-[340px] space-y-8 sticky top-6 self-center">
          <motion.div
          ...
          <ul className="space-y-4 text-base text-neutral-700">
            <li>💳 Paiement sécurisé</li>
            <li>🚚 Livraison offerte – 3-5 jours</li>
            <li>↩️ Retour gratuit 30 jours</li>
            <li>🛍️ Retrait boutique 24 h</li>
          </ul>
        </aside>
      </div>
    </div>
